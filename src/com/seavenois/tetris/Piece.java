...
public class Piece {
	...
	Piece(){
		...
		//type = 6;//TESTING, change to be all the same piece 
		color = (byte) (type + 1);
		rotation = 0;
	...
	//This method is a succession of nested switch() that, first, identify the piece, and, next, rotates from it's previous position
